...
class AnchorGenerator:
    ...
    def grid_priors_single_layer(self, featmap_sizes,level_idx=1, dtype=torch.float32, device='cuda'):
        """Generate grid anchors in multiple feature levels.
        ...
        anchors = self.single_level_grid_priors_single_layer(
            featmap_sizes, level_idx=level_idx, dtype=dtype, device=device)
        # multi_level_anchors.append(anchors)
        return anchors
    def single_level_grid_priors(self,
        ...
        # then (0, 1), (0, 2), ...
        return all_anchors
    def single_level_grid_priors_single_layer(self,
                                 featmap_size,
                                 level_idx,
                                 dtype=torch.float32,
                                 device='cuda'):
