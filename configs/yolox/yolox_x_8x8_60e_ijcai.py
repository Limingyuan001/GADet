...
model = dict(
    ...
    init_cfg = dict(type='Pretrained',checkpoint='D:\Projects\mmdetection\checkpoint\yolox_x_8x8_300e_coco_20211126_140254-1ef88d67.pth'),
    backbone=dict(type='CSPDarknet',deepen_factor=1.33, widen_factor=1.25),
    neck=dict(
        type='YOLOXPAFPN',in_channels=[320, 640, 1280], out_channels=320, num_csp_blocks=4),
    bbox_head=dict(type='YOLOXHead', num_classes=9,in_channels=320, feat_channels=320),
...
# data_root = r'E:\Datasets\IJCAI workshop\train_track1'
data_root = r'E:\Datasets\IJCAI workshop\test标注结果'
CLASSES = ('umbrella', 'knife', 'electronicequipment', 'pressure','lighter','battery','glassbottle','metalbottle','OCbottle')
