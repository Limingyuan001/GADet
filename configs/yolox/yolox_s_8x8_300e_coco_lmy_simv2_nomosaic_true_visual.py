...
model = dict(
    ...
    init_cfg=dict(type='Pretrained',
                  checkpoint=r'D:\Projects\mmdetection\checkpoint\yolox\097\best_bbox_mAP_epoch_46.pth'),
    ...
    neck=dict(
        ...
        num_csp_blocks=1),
    bbox_head=dict(
        type='YOLOXHead_visual', num_classes=15, in_channels=128, feat_channels=128),
    train_cfg=dict(
        assigner=dict(
