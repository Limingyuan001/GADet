...
model = dict(
    ...
    init_cfg=dict(type='Pretrained',
                  checkpoint='D:\Projects\mmdetection\checkpoint\yolox_x_8x8_300e_coco_20211126_140254-1ef88d67.pth'),
    ...
    bbox_head=dict(type='YOLOXHead_PDLC', num_classes=9, in_channels=320, feat_channels=320),
    # type='YOLOX',
    # input_size=img_scale,
    # random_size_range=(15, 25),
    # random_size_interval=10,
    ...
    #     num_csp_blocks=1),
    # bbox_head=dict(
    #     type='YOLOXHead_PDLC', num_classes=15, in_channels=128, feat_channels=128),
    train_cfg=dict(
        assigner=dict(
