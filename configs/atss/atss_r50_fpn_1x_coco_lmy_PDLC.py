...
model = dict(
    ...
    # init_cfg=dict(type='Pretrained',
    #               checkpoint=r'D:\Projects\mmdetection\checkpoint\atss\060\best_bbox_mAP_epoch_52.pth'),
    ...
    #     pos_weight=-1,
    #     debug=False),
    # simOTA head and train cfg
    # bbox_head=dict(
    #     type='YOLOXHead', num_classes=15, in_channels=128, feat_channels=128),
    bbox_head=dict(
        type='YOLOXHead_PDLC', num_classes=15, in_channels=256, feat_channels=256,
        # loss_area=dict(type='AreaLoss_PDLC', loss_weight=7, reduction='sum',
        #            true_w=320,
        #            strides=[32, 16, 8],
        #            means=torch.tensor(
