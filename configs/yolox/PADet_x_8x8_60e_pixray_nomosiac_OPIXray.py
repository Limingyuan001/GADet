...
model = dict(
    ...
    bbox_head=dict(type='YOLOXHead_PDLC', num_classes=5, in_channels=320, feat_channels=320),
    # type='YOLOX',
    # input_size=img_scale,
    # random_size_range=(15, 25),
    # random_size_interval=10,
...
evaluation = dict(interval=5,  metric='mAP', dynamic_intervals=[(max_epochs-last_itervals,1)],save_best='auto')#这里的iterval指的就是epoch
