...
def parse_args():
    ...
    # parser.add_argument('--config', default=r'D:\Projects\mmdetection\configs\atss\atss_r50_fpn_1x_coco_lmy_1280.py',help='train config file path')
    # parser.add_argument('--config', default='D:\Projects\mmdetection\configs\yolo\yolov3_d53_320_273e_coco_cyber.py',help='train config file path')
    # parser.add_argument('--config', default='D:\Projects\mmdetection\configs\yolo\yolov3_d53_320_273e_coco_loss_true_area.py',help='train config file path')
    ...
    parser.add_argument(
        '--output-dir',
        # default=None,
        default=r'D:\Desktop\CYBER\dataset_visual_mix_mosaic\\',
        type=str,
        help='If there is no display interface, you can save it')
    parser.add_argument('--not-show', default=True, action='store_true')#default=False,
    parser.add_argument(
        '--show-interval',
        type=float,
        default=2,
