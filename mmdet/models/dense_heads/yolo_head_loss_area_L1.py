...
class YOLOV3Head_area_L1(BaseDenseHead, BBoxTestMixin):
    ...
    def __init__(self,
                 ...
                 loss_area=dict(type='AreaLoss_L1',loss_weight=1.0),
                 train_cfg=None,
                 test_cfg=None,
                 init_cfg=dict(
                     type='Normal', std=0.01,
                     override=dict(name='convs_pred'))):
        super(YOLOV3Head_area_L1, self).__init__(init_cfg)
        # Check params
    ...
    def loss_single(self, pred_map, target_map, neg_map):
        ...
        loss_area= self.loss_area(pred_wh,pred_label)
