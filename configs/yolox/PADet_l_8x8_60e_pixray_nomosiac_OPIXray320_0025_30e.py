...
model = dict(
    ...
    init_cfg=dict(type='Pretrained',
                  checkpoint='D:\Projects\mmdetection\checkpoint\yolox_l_8x8_300e_coco_20211126_140236-d3bd2b23.pth'),
    backbone=dict(type='CSPDarknet', deepen_factor=1.0, widen_factor=1.0),
    neck=dict(
        type='YOLOXPAFPN', in_channels=[256, 512, 1024], out_channels=256, num_csp_blocks=3),
    bbox_head=dict(type='YOLOXHead_PDLC', num_classes=5, in_channels=256, feat_channels=256),
    # type='YOLOX',
    # input_size=img_scale,
    # random_size_range=(15, 25),
    # random_size_interval=10,
